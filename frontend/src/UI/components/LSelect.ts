...
export default class LSelect extends LComponent {
    ...
    constructor(id: number, label, items: Array<SelectItem>, index = 0, settings: LSelectSettings) {
    ...
    setSubComponents() {
        ...
        if (UI_IC.selectButton(this.buttonText, this.selectBtnSettings)) {
            ...
            UI_IC.selectPopUp(this.setSelection.bind(this), pos, width, this.items, this.currentIndex)
        }
