...
export default class DockingPanel extends Panel {
    ...
    constructor(id: number, panelMain: Panel, panelChild: Panel, settings: DockingPanelSettings) {
        super(id, "", settings);
        this.keepAlive = true;
        ...
        panelMain.parent.removeChild(panelMain)
    ...
    setSubComponents() {
        ...
        if (this.panels[this.selectedIndex].drawChildren = this.drawChildren)
