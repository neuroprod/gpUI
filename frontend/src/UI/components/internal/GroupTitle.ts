...
export default class GroupTitle extends Component
{
    ...
    constructor(id: number,label:string,isOpen:boolean, settings: GroupTitleSettings) {
        super(id, settings);
    ...
    prepDraw() {
        ...
        UI_I.currentDrawBatch.textBatch.addIcon(this.iconPos,icon,settings.labelColor)
