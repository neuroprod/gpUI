    ...
    prepDraw() {
        ...
        if (this.isFocus) {
            ...
            if (!this.isSelecting) {
                ...
                UI_I.currentDrawBatch.textBatch.addIcon(this.cursorDrawPos, 7, settings.colorCursor)
            }
        ...
        UI_I.currentDrawBatch.textBatch.addLine(this.textPos, this.text, this.textMaxSize, colorText)
