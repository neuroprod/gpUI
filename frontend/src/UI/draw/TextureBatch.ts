...
export class  TextureBatchData
{
    ...
    public alpha: number;
    constructor(rect: Rect,uiTexture:UITexture,alpha:number,uvScale:Vec2,uvOffset:Vec2){
...
export default class TextureBatch {
    ...
    addTexture(rect: Rect,uiTexture:UITexture,alpha=1,uvScale:Vec2 =new Vec2(1,1),uvOffset=new Vec2(0,0)) {
