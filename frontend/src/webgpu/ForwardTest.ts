...
export default class ForwardTest {
  ...
  init() {
    ...
    this.material1 = new ForwardMaterial(
      this.device,
      "material1",
      this.normalShader,
    ...
    this.model1 = new Model(
      ...
      true,
      this.camera
    ); //model adds transform data
    this.model1.transform.position = new Vector3(2.4, 0, 0);

    this.material2 = new ForwardMaterial(
      this.device,
      "material2",
      this.colorShader,
      this.presentationFormat,
    ...
    this.material3 = new ForwardMaterial(
      this.device,
      "material3",
      this.uvShader,
      this.presentationFormat,
    ...
    this.material4 = new ForwardMaterial(
      this.device,
      "material4",
      this.textureShader,
      this.presentationFormat,
  ...
  update() {
    ...
    this.material2.setUniform(
      "color",
      UI.LColor("color", new ColorV(1, 0, 1, 1))
    );
